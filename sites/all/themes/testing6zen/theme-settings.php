 ...
 */
function testing6zen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['testing6zen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('testing6zen sample setting'),
  '#default_value' => theme_get_setting('testing6zen_example'),
